...
- uipro-vaadinapp-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- uipro-vaadinapp-ui: main application module, development time
- uipro-vaadinapp-production: module that produces a production mode WAR for deployment
